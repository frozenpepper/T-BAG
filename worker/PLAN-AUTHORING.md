...
- dependencies name graph/existing tasks, are acyclic, and represent **real execution/acceptance prerequisites**, not preferred ordering.
...
- Order/combine tasks that share one hand-written/generated integration surface. Use only supplied roles/tiers; T-BAG-created control/review/gate tasks are not ordinary graph ceremony.
