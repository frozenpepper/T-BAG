...
class DocsTests(unittest.TestCase):
    ...
    def test_parent_harness_wake_contract_is_canonical_in_opencode(self):
        ...
        self.assertIn("first parent tick auto-enrolls heartbeat supervision",hot)
        self.assertIn("Never run core `follow`",hot)
        self.assertIn("normal autonomy does not depend on that custom tool",oc)
        self.assertIn("enrolls heartbeat supervision",oc)
        ...
        self.assertIn("periodic transport heartbeat",oc)
        self.assertIn("wakes are only fast hints",oc.lower())
