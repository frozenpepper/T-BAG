...
class DocsTests(unittest.TestCase):
    ...
    def test_parent_harness_wake_contract_is_canonical_in_opencode(self):
        ...
        self.assertIn("live-plugin probe and optional observer re-arm tool",oc)
        self.assertIn("automatically enrolls that session/run",oc)
        self.assertIn("parent_tick.py tick",oc); self.assertIn("already_armed:true",oc)
