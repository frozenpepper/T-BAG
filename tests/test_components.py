...
class ComponentsTests(unittest.TestCase):
    ...
    def test_opencode_plugin_uses_stable_follow_tool_and_session_wake_not_background_subagent_protocol(self):
        ...
        self.assertIn('runHeartbeats',text); self.assertIn('COMPLETION_PULSE_MS',text); self.assertIn('HEALTH_HEARTBEAT_MS',text); self.assertIn('pulseRun',text); self.assertIn('completionTimer.unref',text); self.assertIn('healthTimer.unref',text)
